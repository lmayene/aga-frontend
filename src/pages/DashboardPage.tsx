    ...
    <Container component="main" maxWidth="lg">
      <Box sx={{ mt: 2 }}>
        <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 4, flexWrap: 'wrap', gap: 2 }}>
          ...
          <Button variant="contained" sx={{ backgroundColor: '#00a6e0' }} component={RouterLink} to="/agentes/novo">
            + Criar Novo Agente
          </Button>
        </Box>
        ...
        <Grid container spacing={3}>
          {filteredAgents.length === 0 ? (
            <Grid item xs={12}>
              <Typography>{searchTerm ? 'Nenhum agente encontrado.' : 'Nenhum agente. Clique em "+ Criar Novo Agente".'}</Typography>
            </Grid>
          ) : (
